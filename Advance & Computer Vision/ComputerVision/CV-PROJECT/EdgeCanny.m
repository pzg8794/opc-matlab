...
figure,
E=edge(G,'canny',[.3  .5], .3);
subplot(1,2,1),imshow(E),title('a')
E=edge(G,'canny',[.3  .75], .3);
subplot(1,2,2),imshow(E),title('b')
BW = edge(E,'canny', .3);

figure,
subplot(1,2,1),imshow(BW),title('c')
BW = edge(E,'canny', .5);
subplot(1,2,2),imshow(BW),title('d')

BW = edge(E,'canny', .7);
figure, imshow(BW)
subplot(1,2,1),imshow(BW),title('e')
BW = edge(E,'canny', .8);
subplot(1,2,2),imshow(BW),title('f')
